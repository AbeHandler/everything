...
\begin{tabular}{cccl}
    ...
    \multirow{1}{*}[0pt]{\textit{Booleans}} % Brian
        & 6 & Sep 28 -- Oct 2 & Definitions, intro to Boolean logic \\   \cmidrule[.1em](lr){1-4}    

   \multirow{1}{*}[0pt]{\textit{Review}} % Brian
        & 7 & Sep 28 -- Oct 2 & Review of unit 1 \\         
...
\begin{tabular}{cccl}
   ...
   \textit{Conditional probability} & 10 & X & Definitions and expected value \\
    ...
    \textit{Midterm 2 review} & 12 & X & Definitions and expected value \\  
...
\begin{tabular}{cccl}
   ...
   \textit{Permutations and combinations} & 14 & X & Definitions and expected value \\
    \cmidrule[.1em](lr){1-4}
        
   \textit{Binomial distribution} & 15 & X & Definitions and expected value \\
    \cmidrule[.1em](lr){1-4}
 
    \textit{Exam review} & 16 & X & Reviewing \\
    \cmidrule[.1em](lr){1-4}
