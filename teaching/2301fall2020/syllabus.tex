...
\author{
    ...
    \myclassroom\\ Zoom: https://cuboulder.zoom.us/j/99814555012
}
...
This class will include many quizzes. These are a big part of the class, and will count almost as much as homeworks and exams towards your final grade. Quizzes might come at the start of class, and test material from the pre-recorded lecture. Or they might come at the end of class, and assess material from in-class exercises. Quizzes will be open book. You can use any materials from the course to answer questions on a quiz. 
...
This class will include many in-class activities, where you write code during the class. You will do in-class activities together in a breakout rooms. It's fine to work together with the people in the breakout room as you do the assignment. 

\section{\textbf{Homeworks}}
This class will have homeworks every few weeks. You may complete the homeworks alone or with one partner. If you work with a partner, be sure to list the partner on your assignment. 
...
\begin{tabular}{ccll}
   ...
   \textit{Conditional probability} & 10 & Oct 26 -- Oct 30  & Definition, applications, practice in Python\\
    ...
    \textit{Review \& Midterm  \#2} & 12 & Nov 9 -- Nov 13  & Review \& Midterm \#2 \\  
...
\begin{tabular}{ccll}
   ...
   \textit{Binomial distribution} & 15 & Nov 23 -- Nov 27   & Definition, introduction to mean and variance \\
    ...
    \textit{Review \& Final Exam } & 16 & Nov 30 -- Dec 4 & Review of course, prep for final exam \\
