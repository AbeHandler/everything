...
\item Conditional probability (with applications in sports, politics and design)
...
\begin{tabular}{cccl}
    ...
    \cmidrule[.1em](lr){1-4} 
     ...
     \multirow{1}{*}[0pt]{\textit{Sets}} % Abe % sql lite. Brian has notebooks
        & 4-5 & Sep 14 -- Sep 25 & Definitions, set operations, practice with \LaTeX \\ 
        \cmidrule[.1em](lr){1-4}
        
    \multirow{1}{*}[0pt]{\textit{Vectors}} % Brian
        & 2-3 & Aug 31 -- Sep 11 & Definitions, vector operations, intro to  \LaTeX  \\ \cmidrule[.1em](lr){1-4}

    \multirow{1}{*}[0pt]{\textit{Booleans}} % Brian
        & 6 & Sep 28 -- Oct 2 & Definitions, intro to Boolean logic, truth tables \\   \cmidrule[.1em](lr){1-4}    
...
\begin{tabular}{cccl}
   ...
   \textit{Simulation} & 8 & X & Simulating data in Python, applications of simulation \\
    \cmidrule[.1em](lr){1-4}

   \textit{Events} & 9 & X & Definition, independence, marginalization \\
    \cmidrule[.1em](lr){1-4}

   \textit{Conditional probability} & 10 & X & Definition, applications, practice in Python\\
    \cmidrule[.1em](lr){1-4}   
 
    \textit{Bayes theorem } & 11 & X & Definition and applications, practice in \LaTeX \\
    \cmidrule[.1em](lr){1-4}   
 
    \textit{Review \& Midterm  \#2} & 12 & X & Review \& Midterm \#2 \\  
...
\begin{tabular}{cccl}
   ...
   \textit{Permutations and combinations} & 14 & X & Definition, explanations, practice \\
    \cmidrule[.1em](lr){1-4}
        
   \textit{Binomial distribution} & 15 & X & Definition, explanations, mean and variance \\
    \cmidrule[.1em](lr){1-4}
 
    \textit{Review \& Final Exam } & 16 & X & Review of course and final exam \\
