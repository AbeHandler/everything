...
They will usually be due by midnight on the day of class. You are NOT expected to work on them outside of class.

\section{\textbf{Homeworks}}
This class will have regular, short homeworks. The homeworks will be fairly similar to the quizzes, but you will do them outside of class instead of in class. You may complete the homeworks alone or with one partner. Homeworks will be open book. You can use any materials from the course (or any resources you find online, though this will be not be necessary) to answer questions on a homework.
