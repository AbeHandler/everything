...
\def\myzoomurl{https://cuboulder.zoom.us/j/93107616365}
\def\mycanvasurl{https://canvas.colorado.edu/courses/70073}
\def\mymeetingdays{Monday, Wednesday, Friday}
\def\mymeetingtimes{12:40 PM-01:30 PM}
\def\mydate{Spring 2021}
...
\def\instructorAofficehours{Monday and Friday from 10 to 11 AM (https://cuboulder.zoom.us/my/abehander)}
...
\author{
    ...
    \myclassroom\\ Zoom: \href{\myzoomurl}{\myzoomurl~(pw=575268)} \\ Canvas:  \href{\mycanvasurl}{\mycanvasurl}
}
...
This class will include many in-class coding activities and math problems. Sometimes you will do them on your own, other times you will do them with a group. You will always turn in in-class activities to Canvas. The instructor will automatically drop the lowest three in-class activities from your final grade.

\textbf{Activities that are turned in will be graded loosely based on effort and correctness, with an understanding that you have limited time to complete the work.}

\section{\textbf{Homeworks}}
This class will have homeworks. The homeworks will be fairly similar to the quizzes, but you will do them outside of class instead of in class. You may complete the homeworks alone or with one partner. Homeworks will be open book. You can use any materials from the course (or any website, though this will be not be necessary) to answer questions on a homework.

\section{\textbf{Exams}}
This class will have two midterm exams and a final exam. The exams will be open book. You can use any materials from the course (or any website, though this will be not be necessary) to answer questions on an exam. \textbf{Exams must be completed on your own. Do not use material from the web to complete an exam. Do not work with other students to complete an exam.}
