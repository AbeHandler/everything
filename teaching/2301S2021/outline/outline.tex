...
\textbf{Note:} In Bayesian statistics, the terms on the right have special names. $p(A)$ is called the ``evidence,'' $p(A \vert B)$ is called the likelihood and $p(B)$ is called the prior. 
