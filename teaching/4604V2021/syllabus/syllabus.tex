...
\def\myzoomurl{https://cuboulder.zoom.us/j/91407330289}
\def\mycanvasurl{https://canvas.colorado.edu/courses/73559}
\def\mymeetingdays{Monday, Wednesday, Friday}
\def\mymeetingtimes{1:15PM--2:30PM}
\def\mydate{Summer 2021}
...
\def\instructorAofficehours{Friday from 12PM to 1 PM (https://cuboulder.zoom.us/my/abehander)}
...
\begin{tabular}{cll}
    ...
    \cmidrule[.1em](lr){1-3} 
     ...
     \multirow{1}{*}[0pt]{\textit{}} 
         2  & Geometry of data, bias and variance & KNN  \\ 
        \cmidrule[.1em](lr){1-3}
        
    \multirow{1}{*}[0pt]{\textit{}} 
         3  & Parameters and learning & Perceptron   \\ \cmidrule[.1em](lr){1-3}

    \multirow{1}{*}[0pt]{} 
         4 & Optimization and loss & Logistic regression \\   \cmidrule[.1em](lr){1-3}    

   \multirow{1}{*}[0pt]{} % Brian
         5 &  Regularization & Logistic regression  \\ \cmidrule[.1em](lr){1-3}             

     6 & Generative models & Naive Bayes \\
    \cmidrule[.1em](lr){1-3} 

    7  &  Train/test split, overfitting  &  All methods  \\
    \cmidrule[.1em](lr){1-3}

   8   & Non-linear prediction, ensembles  & decision trees, random forests \\
    \cmidrule[.1em](lr){1-3}
...
\begin{tabular}{cll}
    ...
    \cmidrule[.1em](lr){1-3}
     ...
     9  & Data creation &  Annotation and agreement \\
    \cmidrule[.1em](lr){1-3} 
 
     10  & Feature creation &  The art of feature engineering \\
    \cmidrule[.1em](lr){1-3} 

     11  & Evaluation and diagnosis &  Precision, recall, ROC AUC, confusion matrixes \\
    \cmidrule[.1em](lr){1-3} 

     12  & Review and midterm &   \\
    \cmidrule[.1em](lr){1-3} 
