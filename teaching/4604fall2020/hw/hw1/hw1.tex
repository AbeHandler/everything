...
A more interesting example is with {\em sepal length} and {\em sepal width} (columns 1 and 2).
The data are still linearly separable in these two dimensions, but it requires a combination of both variables.
