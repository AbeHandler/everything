...
\centering
\begin{tabular}{ccll}
    \textbf{} & \textbf{Week} & \textbf{Dates} & \textbf{Details} \\
    \cmidrule[.1em](lr){1-4}
    
    \textit{} & 1 & Aug 24 -- Aug 28 & Intro to machine learning \\
    \cmidrule[.1em](lr){1-4} 
 
     \multirow{1}{*}[0pt]{\textit{}} 
        & 2-3 & Aug 31 -- Sep 4 & Geometry of data, linear predictors \\ 
        \cmidrule[.1em](lr){1-4}
        
    \multirow{1}{*}[0pt]{\textit{}} 
        & 4-5 & Sep 7 -- Sep 18 & Optimization, learning and loss \\ \cmidrule[.1em](lr){1-4}

    \multirow{1}{*}[0pt]{} 
        & 6 & Sep 21 -- Sep 25 & Classification: Logistic regression and Naive Bayes \\   \cmidrule[.1em](lr){1-4}    

   \multirow{1}{*}[0pt]{} % Brian
        & 7 & Sep 28 -- Oct 2 &  Non-linear prediction \\ \cmidrule[.1em](lr){1-4}             

\end{tabular}\\
\caption{Foundations of ML}
\end{table}
