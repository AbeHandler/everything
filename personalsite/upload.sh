...
aws s3 cp _site/archives/2020/02/03/news-indexes.html s3://www.abehandler.com/archives/2020/02/03/news-indexes.html --acl public-read --content-type text/html
